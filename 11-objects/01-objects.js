...
//     };
   ...
   //console.log('Juest season info:', netflix.season1.seasonInfo)
   //console.log('episode Name:', netflix.season1.seasonInfo.episodeInfo[0].episodeName)



   //console.log('EpisodeName:', netflix.season1.seasonInfo.episodeInfo[8].episodeName)

  // let var episodeN = (netflix.season1.seasonInfor.episodeInfor[8].episodeName)
